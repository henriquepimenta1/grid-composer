...
const HARMONIES = [
  ...
  { id:'custom', name:'IA decide', dot:'linear-gradient(135deg,#888,#444)', colors:['#888888','#444444'], angle:'auto', when:'A IA analisa suas fotos e escolhe a harmonia que melhor se aplica ao conjunto.', example:'🤖 análise automática do conjunto', feel:'Adaptativo · otimizado para suas fotos' },
]
...
const PATTERNS = [
  ...
  { id:'free', name:'Livre (IA)', cells:[null,null,null,null,null,null], when:'A IA decide o melhor arranjo para o seu conjunto específico de fotos.', example:'🤖 arranjo otimizado pela IA', feel:'Flexível · otimizado · adaptativo' },
]
